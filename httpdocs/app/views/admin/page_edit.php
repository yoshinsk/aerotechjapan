...
<form class="admin-form" method="post" action="<?= e(url('/admin/page-edit')) ?>">
    ...
    <label>本文（日本語・HTML可）<textarea name="body_ja" rows="14"><?= e($page['body_ja'] ?? '') ?></textarea></label>
    <label>Body（英語・HTML可）<textarea name="body_en" rows="14"><?= e($page['body_en'] ?? '') ?></textarea></label>
