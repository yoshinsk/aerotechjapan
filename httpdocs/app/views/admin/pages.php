...
<table class="admin-table">
    <thead><tr><th>slug</th><th>タイトル</th><th>状態</th><th>公開URL</th><th></th></tr></thead>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <?php if ($page['is_active']): ?>
                    <a href="<?= e(public_page_url($page)) ?>" target="_blank" rel="noopener noreferrer">公開ページ</a>
                <?php else: ?>
                    <span class="muted">非公開</span>
                <?php endif; ?>
            </td>
